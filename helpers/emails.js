...
await transporter.sendMail({
    ...
    <a href="${process.env.BACKEND_URL}api/v1/auth/confirmarCuenta/${token}" class="btn">Confirmar Email</a>
...
await transporter.sendMail({
    ...
    <a href="${process.env.BACKEND_URL}api/v1/auth/reset-password/${token}" class="btn">Confirmar Email</a>
